...
[SEGMENT .data]
    strWelcomeMsg   db  "Welcome to GimmyOS! Thanks for using this operating system.", 0x00
	strPrompt		db	"GimmyOS>>", 0x00
	cmdMaxLen		db	255			;maximum length of commands

	strOsName		db	"GimmyOS - edited by JOSH", 0x00	;OS details
	strMajorVer		db	"0", 0x00
	strMinorVer		db	".03", 0x00

	cmdVer			db	"ver", 0x00		; Internal commands
	cmdExit			db	"exit", 0x00    ; Exit and Reboot the system
    ...
    strHelpMsg1		db  "To check the version - type ver",0x00
	strHelpMsg2		db  "To reboot the system - type exit",0x00
	strHelpMsg3		db  "Fot hardware-information - type info",0x00
